#!/usr/bin/env python3
"""
MediaMeshMenu — ClickMesh-generated context menu extension for Nemo (Cinnamon).
...
def _path_from_item(file_item):
    """Extract a local filesystem path from a Nemo FileInfo object."""
...
class MediameshmenuExtension(GObject.GObject, Nemo.MenuProvider):
    """Injects a 'Media Mesh Convert' submenu into the Nemo right-click menu."""
