...
class MediameshmenuExtension(GObject.GObject, Nemo.MenuProvider):
    """Injects a 'Media Mesh' submenu into the Nemo right-click menu."""
    ...
    def get_file_items(self, window, files):
        ...
        if show_item_1:
            if 'Convert Video' not in menus:
                group_item = Nemo.MenuItem(name='MediaMeshMenu::Convert Video', label='Convert Video', tip='Convert Video')
        ...
        if show_item_5:
            ...
            if 'Convert Video/Professional' not in menus:
                group_item = Nemo.MenuItem(name='MediaMeshMenu::Convert Video/Professional', label='Professional', tip='Professional')
                group_menu = Nemo.Menu()
                group_item.set_submenu(group_menu)
        ...
        if show_item_7:
            if 'Extract Audio' not in menus:
                group_item = Nemo.MenuItem(name='MediaMeshMenu::Extract Audio', label='Extract Audio', tip='Extract Audio')
                group_menu = Nemo.Menu()
                group_item.set_submenu(group_menu)
                menus[''].append_item(group_item)
        ...
        if show_item_10:
            if 'Images & Animations' not in menus:
                group_item = Nemo.MenuItem(name='MediaMeshMenu::Images & Animations', label='Images & Animations', tip='Images & Animations')
                group_menu = Nemo.Menu()
                group_item.set_submenu(group_menu)
                menus[''].append_item(group_item)
